...
<%
	...
	Dim strlsh, strddh, strkhmc, strjsdj,strdmdj,strmjlx, strxcjy, strrwlx,strtsyl,strcjqy
	Dim strmz, strbh, strtscs, strjhjs, strscxh, strqysd, strsml, strgjl,strrwnr,strqs 
	Dim StrCntsfz, StrScxfz, StrCwtsfz, StrZxfz, strMjdj
	
	'任务书所有变量初始化
strlsh=Trim(Request("lsh")) : strddh=Trim(Request("ddh")) : strkhmc=Trim(Request("khmc")) : strrwnr=Request("rwnr") : strjsdj=Request("jsdj") : strdmdj=Request("dmdj") : strmjlx=Request("mjlx") : strmz=Request("mz") : strbh=Request("bh") : strtscs=Request("tscs") : strjhjs=Request("jhjs") : strscxh=Request("scxh") : strqysd=Request("qysd") : strxcjy=Request("xcjy") : StrCntsfz=Request("Cntsfz") : StrScxfz=Request("Scxfz") : StrCwtsfz=Request("Cwtsfz") : StrZxfz=Request("Zxfz") : strtsyl=Request("tsyl") : strMjdj=Request("mjdj") : strcjqy=Request("cjqy") : strqs=Request("qs")
...
'			If strjhjs<>"" Then Rs("jhjssj")=strjhjs End If
			Rs("smlqk")=strsml
