	...
	if Action="Modify" then
		...
		if FoundErr<>True then
			...
			if NewBigClassName<>OldBigClassName then
				...
				conn.execute "Update Products set BigClassName='" & NewBigClassName & "' where BigClassName='" & OldBigClassName & "'"
     		end if		
			call CloseConn()
     		Response.Redirect "ClassManage.asp" 
		end if
    ...
    <td align="center" valign="top"> <br> <br> <strong>产 品 类 别 设 置</strong> <br> 
      <br> <br> <form name="form1" method="post" action="ClassModifyBig.asp">
        <table width="350" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#ECF5FF" class="border">
          ...
          <tr class="tdbg"> 
            <td width="126" height="20" bgcolor="#A4B6D7"><strong>大类名称：</strong></td>
            <td> 
