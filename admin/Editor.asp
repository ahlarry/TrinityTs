...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="全部选择" LANGUAGE="javascript" onclick="format('selectall')"> 
    <img class="Ico" src="Editor/selectall.gif" > </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="剪切" LANGUAGE="javascript" onclick="format('cut')"> <img class="Ico" src="Editor/cut.gif" > 
  </div>
  <div class="Btn" TITLE="复制" LANGUAGE="javascript" onclick="format('copy')"> 
    <img class="Ico" src="Editor/copy.gif" > </div>
  <div class="Btn" TITLE="粘贴" LANGUAGE="javascript" onclick="format('paste')"> 
    <img class="Ico" src="Editor/paste.gif" > </div>
  <div class="Btn" TITLE="从word中粘贴" LANGUAGE="javascript" onclick="word()"> <img class="Ico" src="Editor/wordpaste.gif" > 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查找替换" LANGUAGE="javascript" onclick="findstr()"><img class="Ico" src="Editor/findreplace.gif" ></div>
  <div class="Btn" TITLE="删除" LANGUAGE="javascript" onclick="format('delete')"><img class="Ico" src="Editor/del.gif" ></div>
  <div class="Btn" TITLE="删除文字格式" LANGUAGE="javascript" onclick="format('RemoveFormat')"><img class="Ico" src="Editor/clear.gif" ></div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="撤消" LANGUAGE="javascript" onclick="format('undo')"> 
    <img class="Ico" src="Editor/undo.gif" > </div>
  <div class="Btn" TITLE="恢复" LANGUAGE="javascript" onclick="format('redo')"> 
    <img class="Ico" src="Editor/redo.gif" > </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="计算器" LANGUAGE="javascript" onclick="calculator()"> <img class="Ico" src="Editor/calculator.gif" > 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="Insermenu('<%=now()%>')"> 
    <img class="Ico" src="Editor/save.gif" > </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onclick="help()"><img class="Ico" src="Editor/help.gif" > 
  </div>
  <div class="TBSep"></div>
...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onclick="foreColor()"><img class="Ico" src="Editor/fgcolor.gif" ></div>
  <div class="Btn" TITLE="文字背景色" LANGUAGE="javascript" onclick="backColor()"><img class="Ico" src="Editor/fgbgcolor.gif" ></div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="加粗" LANGUAGE="javascript" onclick="format('bold')"> 
    <img class="Ico" src="Editor/bold.gif" > </div>
  <div class="Btn" TITLE="斜体" LANGUAGE="javascript" onclick="format('italic')"> 
    <img class="Ico" src="Editor/italic.gif" > </div>
  <div class="Btn" TITLE="下划线" LANGUAGE="javascript" onclick="format('underline')"> 
    <img class="Ico" src="Editor/underline.gif" > </div>
  <div class="Btn" TITLE="删除线" LANGUAGE="javascript" onclick="format('StrikeThrough')"> 
    <img class="Ico" src="Editor/strikethrough.gif" > </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="左对齐" NAME="Justify" LANGUAGE="javascript" onclick="format('justifyleft')"><img class="Ico" src="Editor/Aleft.gif" ></div>
  <div class="Btn" TITLE="居中" NAME="Justify" LANGUAGE="javascript" onclick="format('justifycenter')"><img class="Ico" src="Editor/Acenter.gif" ></div>
  <div class="Btn" TITLE="右对齐" NAME="Justify" LANGUAGE="javascript" onclick="format('justifyright')"><img class="Ico" src="Editor/Aright.gif" ></div>
  <div class="Btn" TITLE="两端对齐" NAME="Justify" LANGUAGE="javascript" onclick="format('JustifyFull')"><img class="Ico" src="Editor/JustifyFull.gif" ></div>
  <div class="Btn" TITLE="绝对或相对位置" LANGUAGE="javascript" onclick="absolutePosition()"><img class="Ico" src="Editor/abspos.gif" ></div>
</div>
<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  <div class="Btn" TITLE="字体变大" LANGUAGE="javascript" onclick="inserteshu('big')"><img class="Ico" src="Editor/tobig.gif" ></div>
  <div class="Btn" TITLE="字体变小" LANGUAGE="javascript" onclick="inserteshu('small')"><img class="Ico" src="Editor/tosmall.gif" ></div>
  <div class="Btn" TITLE="上标" LANGUAGE="javascript" onclick="format('superscript')"><img class="Ico" src="Editor/sup.gif" ></div>
  <div class="Btn" TITLE="下标" LANGUAGE="javascript" onclick="format('subscript')"><img class="Ico" src="Editor/sub.gif" ></div>
  <div class="Btn" TITLE="编号" LANGUAGE="javascript" onclick="format('insertorderedlist')"> 
    <img class="Ico" src="Editor/num.gif" > </div>
  <div class="Btn" TITLE="项目符号" LANGUAGE="javascript" onclick="format('insertunorderedlist')"> 
    <img class="Ico" src="Editor/list.gif" > </div>
  <div class="Btn" TITLE="减少缩进量" LANGUAGE="javascript" onclick="format('outdent')"> 
    <img class="Ico" src="Editor/outdent.gif" > </div>
  <div class="Btn" TITLE="增加缩进量" LANGUAGE="javascript" onclick="format('indent')"> 
    <img class="Ico" src="Editor/indent.gif" > </div>
  <div class="Btn" TITLE="上移一层" LANGUAGE="javascript" onclick="zIndex('forward')"><img class="Ico" src="Editor/forward.gif" > 
  </div>
  <div class="Btn" TITLE="下移一层" LANGUAGE="javascript" onclick="zIndex('backward')"><img class="Ico" src="Editor/backward.gif" > 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onclick="UserDialog('CreateLink')"> 
    <img class="Ico" src="Editor/url.gif" > </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onclick="UserDialog('unLink')"> 
    <img class="Ico" src="Editor/nourl.gif" > </div>
  <div class="Btn" TITLE="插入普通水平线" LANGUAGE="javascript" onclick="format('InsertHorizontalRule')"> 
    <img class="Ico" src="Editor/line.gif" > </div>
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()"><img class="Ico" src="Editor/sline.gif" > 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入输入框" LANGUAGE="javascript" onclick="Insergongneng('input')"> 
    <img class="Ico" src="Editor/FormText.gif" > </div>
  <div class="Btn" TITLE="插入文字输入区" LANGUAGE="javascript" onclick="Insergongneng('textarea')"> 
    <img class="Ico" src="Editor/FormTextArea.gif" > </div>
  <div class="Btn" TITLE="插入单选钮" LANGUAGE="javascript" onclick="Insergongneng('radio')"> 
    <img class="Ico" src="Editor/FormRadio.gif" > </div>
  <div class="Btn" TITLE="插入复选框" LANGUAGE="javascript" onclick="Insergongneng('checkbox')"> 
    <img class="Ico" src="Editor/FormCheckbox.gif" > </div>
  <div class="Btn" TITLE="插入下拉菜单" LANGUAGE="javascript" onclick="Insermenu('<%=now()%>')"> 
    <img class="Ico" src="Editor/menu.gif" > </div>
  <div class="Btn" TITLE="插入按钮" LANGUAGE="javascript" onclick="Insergongneng('bottom')"> 
    <img class="Ico" src="Editor/FormButton.gif" > </div>
</div>

<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  <div class="Btn" TITLE="插入手动分页符" LANGUAGE="javascript" onclick="page()"><img class="Ico" src="Editor/page.gif" > 
  </div>
  <div class="Btn" TITLE="插入当前日期" LANGUAGE="javascript" onclick="nowdate()"> <img class="Ico" src="Editor/date.gif" > 
  </div>
  <div class="Btn" TITLE="插入当前时间" LANGUAGE="javascript" onclick="nowtime()"> <img class="Ico" src="Editor/time.gif" > 
  </div>
  <div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onclick="FIELDSET()"><img class="Ico" src="Editor/fieldset.gif" > 
  </div>
  <div class="Btn" TITLE="插入网页" LANGUAGE="javascript" onclick="iframe()"><img class="Ico" src="Editor/htm.gif" > 
  </div>
  <div class="Btn" TITLE="插入Excel表格" LANGUAGE="javascript" onclick="excel()"><img class="Ico" src="Editor/excel.gif" > 
  </div>
  <div class="Btn" TITLE="插入表格" LANGUAGE="javascript" onclick="InsertTable()"> 
    <img class="Ico" src="Editor/table.gif" > </div>
  ...
  <div class="Btn" TITLE="插入换行符号" LANGUAGE="javascript" onclick="InsertChars(0)"><img class="Ico" src="Editor/chars.gif" ></div>
  <div class="Btn" TITLE="插入公式" LANGUAGE="javascript" onclick="InsertEQ()"><img class="Ico" src="Editor/eq.gif" ></div>
  <div class="BtnMenu" TITLE="公式操作" LANGUAGE="javascript" onclick="ShowMenu(menu_eq,100)"><img class="Ico" src="Editor/arrow.gif"></div>
  <div class="Btn" TITLE="插入特殊符号" LANGUAGE="javascript" onclick="Insertlr('editor_tsfh.htm',300,200,<%=(now()-date())*24*60*60*1000%>)"><img class="Ico" src="Editor/symbol.gif" ></div>
  <div class="Btn" TITLE="插入表情符号" LANGUAGE="javascript" onclick="inseremot()"><img class="Ico" src="Editor/Emot.gif" ></div>
  <div class="Btn" TITLE="插入图片，支持格式为：jpg、gif、bmp、png等" LANGUAGE="javascript" onclick="pic()"><img class="Ico" src="Editor/img.gif" ></div>
  <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"><img class="Ico" src="Editor/flash.gif" ></div>
  <div class="Btn" TITLE="插入视频文件，支持格式为：avi、wmv、asf" LANGUAGE="javascript" onclick="wmv()"><img class="Ico" src="Editor/wmv.gif" ></div>
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"><img class="Ico" src="Editor/rm.gif" ></div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="代码样式" LANGUAGE="javascript" onclick="Insercode()"> <img class="Ico" src="Editor/code.gif" > 
  </div>
  <div class="Btn" TITLE="引用样式" LANGUAGE="javascript" onclick="Inserquote()"> 
    <img class="Ico" src="Editor/quote.gif" > </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入或修改字幕" LANGUAGE="javascript" onclick="insermarquee()"> 
    <img class="Ico" src="Editor/Marquee.gif" > </div>
  <div class="Btn" TITLE="打印" LANGUAGE="javascript" onclick="format('Print')"> 
    <img class="Ico" src="Editor/print.gif" > </div>
</div>

<iframe class="HtmlEdit" ID="HtmlEdit" src="editor_Content.asp?Action=<%=trim(request("Action"))%>&ArticleID=<%=trim(request("ArticleID"))%>&Tb=<%=request("Tb")%>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=266;"> </iframe>
