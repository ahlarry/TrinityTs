...
sub ProductContent(intTitleLen)
	...
	do while not rsProducts.eof
		...
		strTemp= strTemp & "<table width=100% border=0 cellspacing=3 cellpadding=0>"
				...
				strTemp= strTemp & "<td width=50% height=12>"
                strTemp= strTemp & "<div align=center><input name='Product_Id' type='checkbox'    id='Product_Id' value="&cstr(rsProducts("Product_Id"))&"> 选取"
...
sub ShowUserLogin()
	...
	If Session("UserName")="" Then
        ...
        strLogin=strLogin & "<tr><td  height='25' align='right'>用&nbsp;&nbsp;户：</td><td width='13' height='25'><input name='UserName' type='text' id='UserName' size='8' maxlength='20' class='login'></td><td width='47'   rowspan='2'><input name='Login' type='image' src='Imgv2/login.gif'   id='Login' value=' 登录 ' ></td></tr>"
        strLogin=strLogin & "<tr><td height='25' align='right'>密&nbsp;&nbsp;码：</td><td height='25'><input name='Password' type='password' id='Password' size='8' maxlength='20'  class='login'></td></tr>"
