...
INPUT{
	...
	background-image: url(Images_v1/yx2_2.gif);
}
</style>
...
<table align='center' width='300' border='0' cellpadding='4' cellspacing='0' class='border'>
  ...
  <tr> 
    <td height='100' colspan='2' align="center" bgcolor="#FFDF7D" class='tdbg'><form name="form1" method="post" action="">
...
%>
<table width='300' border='0' align='center' cellpadding='4' cellspacing='0' bgcolor="#FFDF7D" class='border'>
  <tr > 
    <td height='15' colspan='2' bgcolor="#FFCC33" class='title'>忘记密码 &gt;&gt; 第二步：回答问题</td>
  </tr>
  <tr> 
...
<table width='300' border='0' align='center' cellpadding='4' cellspacing='0' bgcolor="#FFDF7D" class='border'>
  <tr > 
    <td height='15' colspan='2' bgcolor="#FFCC33" class='title'>忘记密码 &gt;&gt; 第三步：设置新密码</td>
  </tr>
  <tr> 
    <td height='100' colspan='2' align="center" class='tdbg'><form name="form1" method="post" action="">
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
...
<table width='300' border='0' align='center' cellpadding='4' cellspacing='0' bgcolor="#FFDF7D" class='border'>
  <tr > 
    <td height='15' colspan='2' bgcolor="#FFCC33" class='title'>忘记密码 &gt;&gt; 第四步：成功设置新密码</td>
  </tr>
  <tr> 
