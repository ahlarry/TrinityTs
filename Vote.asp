...
<br>
<table  width="600" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCE6E6">
  <tr> 
    <td class="tdbg_left">
<%
if Action="Vote"  then
	...
	response.write "<br><br>&nbsp;&nbsp;非常感谢您的投票！</font><br>"
      ...
      <table width="600" border="0" align="center" cellpadding="2" cellspacing="0" class="border">
        <tr align="center" > 
          <td height="35" colspan="3" bgcolor="#99CC99"><strong>调 查 结 果</strong></td>
  </tr>
  <tr class="tdbg"><td>
   <table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#99CC99">
              <tr> 
                <td width="140" align="right" bgcolor="#CCE6E6"><div align="center"><strong>调查内容：</strong></div></td>
                <td colspan="2" bgcolor="#CCE6E6"><%=rsVote("Title")%></td>
              </tr>
              <tr> 
                <td width="140" align="right" bgcolor="#CCE6E6"><div align="center"><strong>总投票数：</strong></div></td>
                <td colspan="2" bgcolor="#CCE6E6"> 
 <%
  dim totalVote
  totalVote=0
  for i=1 to 8
  ...
  %>
              ...
              <tr> 
                <td colspan="3" align="center" bgcolor="#CCE6E6">&nbsp;</td>
              </tr>
              <tr> 
                <td width="140" align="center" bgcolor="#CCE6E6"><strong>投票选项</strong></td>
                <td width="64" align="right" bgcolor="#CCE6E6"><div align="center"><strong>票数</strong></div></td>
                <td width="388" align="center" bgcolor="#CCE6E6"><strong>百分比</strong></td>
              </tr>
              <%
  for i=1 to 8
  ...
  %>
              <tr> 
                <td width="140" align="right" bgcolor="#CCE6E6"><div align="center"><%=rsVote("Select"& i)%> 
                </div></td>
                <td align="right" bgcolor="#CCE6E6"> 
                  <div align="center"><%
