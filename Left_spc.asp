...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="imgV2/left_spc.gif" width="211" height="30" /></td>
  </tr>
  <tr>
    <td align="center"><table width="86%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <TD width="100%"><a href='spc_add.asp'>添加零星任务</a></TD>
        </tr>
        <tr>
          <TD width=34 height=24 align=center><IMG src="img/class1.gif" width=20 height=20></TD>
          <TD width="100%"><a href='spc_change.asp'>更改零星任务 </a></TD>
        </tr>
        <tr>
          <TD width=34 height=24 align=center><IMG src="img/class1.gif" width=20 height=20></TD>
          <TD width="100%"><a href='spc_list.asp'>零星任务列表 </a></TD>
        </tr>        
      </table></td>
  </tr>
  <tr>
